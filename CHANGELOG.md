...
### Fixed
- Plugin.json counts corrected, orchestrator dispatch clarified, session snapshot error handling, model format, incident resumability, isolated context definition
